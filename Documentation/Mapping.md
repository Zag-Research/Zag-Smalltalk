...
7. SmallInteger: For integers the "hash code" is the value and it uses the last 2 of the tags, so this provides 49-bit integers (-281,474,976,710,656 to 281,474,976,710,655).
