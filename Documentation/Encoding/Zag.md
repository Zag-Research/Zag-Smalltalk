...
- 2: `SmallInteger`. Recognized by `u & 2 != 0`. This provides 62-bit `SmallInteger` values in the high bits. (note this test matches 3,6,7 - which can be other special types of `SmallInteger`)
