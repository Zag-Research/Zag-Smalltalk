// Old version of Modified Spur encoding
...
pub fn main() !void {
    ...
    const data = .{
        ...
        0.0,                -0.0,               xMin,  pow(f64, 2.0, -767), pow(f64, 2.0, -511),
        xSmall,             xSmall2,            0.5,   0.75,                1.0,
        -1.0,               2.0,                xBig,  -xBig,               pow(f64, 2.0, 257),
        pow(f64, 2.0, 513), pow(f64, 2.0, 769), xMax,  -xMax,               xInf,
        -xInf,              xNaN,               -xNaN,
    };
    inline for (data) |x| {
