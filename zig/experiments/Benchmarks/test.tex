...
%    xlabel={Benchmark},
    symbolic x coords={Integer, Float},
    xtick=data,
    ymin=0,
    ymax=4050, %#1,
    legend style={
...
\begin{figure}[htbp]
    \centering
    \aarchScatterPlot
    \caption{Integer vs Float - AARCH64}
    \label{paretoA}
\end{figure}
\begin{figure}[htbp]
    \centering
    \xScatterPlot
    \caption{Integer vs Float - X86-64}
    \label{paretoX}
\end{figure}
\begin{figure}[htbp]
    \centering
    \aarchScatterPlotClosure
    \caption{Integer vs Float - BlockClosures - AARCH64}
    \label{paretoAC}
\end{figure}
\begin{figure}[htbp]
    \centering
    \xScatterPlotClosure
    \caption{Integer vs Float - BlockClosures - X86-64}
    \label{paretoXC}
\end{figure}
\begin{figure}[htbp]
    \centering
    \aarchScatterPlotBoth
    \caption{Both - BlockClosures - AARCH64}
    \label{paretoAB}
\end{figure}
\begin{figure}[htbp]
    \centering
