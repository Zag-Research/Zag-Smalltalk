...
pub const immediateIntegers = switch (objectEncoding) {
    .zag, .nan, .zagSpur, .zagOrig, .compact1, .compact2, .compact4, .compact6, .compactI1, .compactI2, .compactI4, .compactI6, .compactY, .compactZ, .compactA2, .spur, .spurOpt, .spurNZ, .spurFST, .onlyInt, .taggedInt, .taggedLow, .taggedHigh => true,
    else => false,
};
pub const immediateSymbols = switch (objectEncoding) {
    .zag, .nan, .zagSpur, .zagOrig, .compact1, .compact2, .compact4, .compact6, .compactI1, .compactI2, .compactI4, .compactI6, .compactY, .compactZ, .compactA2, .onlyInt, .onlyFloat, .taggedLow, .taggedHigh => true,
    else => false,
};
