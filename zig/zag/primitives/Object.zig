...
const embedded = struct {
    pub fn @"basicAt:"(pc: PC, sp: SP, process: *Process, context: *Context, _: Extra) callconv(stdCall) SP {
    ...
    pub fn @"basicAt:put:"(pc: PC, sp: SP, process: *Process, context: *Context, _: Extra) callconv(stdCall) SP {
        sp[1] = inlines.p61(sp[1], sp[0]) catch return @call(tailCall, fallback, .{ pc, sp, process, context, Sym.@"basicAt:put:" });
        return @call(tailCall, pc[0].prim, .{ pc + 1, sp + 1, process, context, undefined, undefined });
    }
    pub fn p110(pc: PC, sp: SP, process: *Process, context: *Context, _: Extra) callconv(stdCall) SP { // ProtoObject>>#==
        return @call(tailCall, pc.prim(), .{ pc.next(), sp.dropPut(Object.from(inlines.p110(sp.next, sp.top))), process, context, undefined });
    }
    pub fn p169(pc: PC, sp: SP, process: *Process, context: *Context, _: Extra) callconv(stdCall) SP { // ProtoObject>>#~~
    ...
    pub fn p145(pc: PC, sp: SP, process: *Process, context: *Context, _: Extra) callconv(stdCall) SP { // atAllPut:
...
pub const primitive60 = struct {
    pub const number = 60;
    pub fn primitive(pc: PC, sp: SP, process: *Process, context: *Context, extra: Extra) callconv(stdCall) SP { // basicAt:
...
pub const primitive110 = struct {
    ...
    pub fn primitive(pc: PC, sp: SP, process: *Process, context: *Context, extra: Extra) callconv(stdCall) SP { // ==
...
const primitives = struct {
    pub fn p61(pc: PC, sp: SP, process: *Process, context: *Context, extra: Extra) callconv(stdCall) SP { // basicAt:put:
        _ = (.{ pc, sp, process, context, extra });
        unreachable;
    }
    pub fn p83(pc: PC, sp: SP, process: *Process, context: *Context, extra: Extra) callconv(stdCall) SP { // perform: perform:with: perform:with:with: perform:with:with:with:
        _ = (.{ pc, sp, process, context, extra });
        unreachable;
    }
    pub fn p84(pc: PC, sp: SP, process: *Process, context: *Context, extra: Extra) callconv(stdCall) SP { // perform:withArguments:
        _ = (.{ pc, sp, process, context, extra });
        unreachable;
    }
    pub fn p100(pc: PC, sp: SP, process: *Process, context: *Context, extra: Extra) callconv(stdCall) SP { // perform:withArguments:inSuperclass:
        _ = (.{ pc, sp, process, context, extra });
        unreachable;
    }
    pub fn p145(pc: PC, sp: SP, process: *Process, context: *Context, extra: Extra) callconv(stdCall) SP { // atAllPut:
        _ = (.{ pc, sp, process, context, extra });
    ...
    pub fn p169(pc: PC, sp: SP, process: *Process, context: *Context, extra: Extra) callconv(stdCall) SP { // ProtoObject>>#~~
        _ = (.{ pc, sp, process, context, extra });
